...
\begin{itemize}
    ...
    processing, but given the challenges in estimating prostate gland size in
    histology (detailed in the response to the second reviewer below), our
    pathologist (AB) believed that the most accurate estimations of \invivo
    prostate dimensions would be taken from the gross pathology specimens.  In
    consulting with our pathologist on this specific comment, his impression
    was that the impact of extraprostatic tissue would be minimal,  so we have
    removed this section from the discussion to focus on more relevant points.
