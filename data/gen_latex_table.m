...
for i=1:size(data,1),
    fprintf(fid,'%i & %.2f & %.2f & %.2f & %.2f & %.2f & %.2f & %.2f & %.2f & %.2f & %.2f & %.2f & %.2f \\\\ \n',i,data(i,4)/10,data(i,12)/10,data(i,5)/10,data(i,13)/10,data(i,6)/10,data(i,14)/10,data(i,7)/10,data(i,15)/10,data(i,8)/10,data(i,16)/10,data(i,9)/10,data(i,17)/10);
end;
