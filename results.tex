...
Measurements of the prostate dimensions along the three standard anatomic axes
(apex-to-base, lateral-to-lateral, and anterior-to-posterior) were made
(Table~\ref{tab:mr_arfi_axes}), and the correlation between the imaging axis
measurements and pathology was performed (Figure~\ref{fig:mr_arfi_path_axes}).
To evaluate the relative shape of the prostate in each imaging modality, the
...
imaging (Figure~\ref{fig:mr_arfi_central_axes}).  The mean ratio differences
between ARFI imaging, T2WI MR and pathology are compiled in
